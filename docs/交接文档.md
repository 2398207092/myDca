...
- 14 文件 → 5 维护文件
- 新目录结构：`docs/优化/`、`docs/参考/`、`docs/设计/v2界面/`（文件名已全部改为中文）
...
5. V2 UI 升级（日历页 3 卡片 + 发现页财富森林，设计已完成在 `docs/设计/v2界面/`）
...
docs/
├── 交接文档.md               # 本文档
├── 优化/计划.md              # 优化进度（22 问题，15 已修复）
├── 参考/                     # 长期参考（财务算法、分红路线图、年化收益率IRR算法）
│   ├── 财务算法.md
│   ├── 分红路线图.md
│   └── 年化收益率IRR算法.md
└── 设计/v2界面/              # 已完成设计输出（tailwind配置、主样式、核心页面等）
